      ...
      <view className="Page">
        ...
        <text className="TeamName">CapΔ</text>
          <view className="NavLinks">
            ...
            <text className="CTA">Get Started</text>
          </view>
        </view>
          ...
          <view className="Hero">
            <view className="HeroText">
              ...
              <text className="HeroSubtitle">Your AI chatbot that puts your data first.</text>
                <text 
                className="CTA" style = "margin-top: 10px" bindtap={() => setShowDemo(true)}>Start Chatting</text>
            </view>
        ...
        {showDemo && (
          <view className="Chatbox">
            ...
            <view className="UserBubble">
              <text>I need support with my account</text>
            </view>
